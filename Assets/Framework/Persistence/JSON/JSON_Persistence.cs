...
namespace RoaringSnail.WinningStreak.PersistenceSystems.JSON
{
    ...
    public class JSON_Persistence : MonoBehaviour
    {
        ...
        public void Save()
        {
            ...
            // TODO: Warning CA2202 Object 'fs' can be disposed more than once in method 
            // 'JSON_Persistence.Save()'.To avoid generating a System.ObjectDisposedException
            // you should not call Dispose more than one time on an object
