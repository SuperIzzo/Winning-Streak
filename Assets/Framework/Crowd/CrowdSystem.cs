...
namespace RoaringSnail.WinningStreak
{
    ...
    public class CrowdSystem : MonoBehaviour
    {
        ...
        //--------------------------------------
        [SerializeField]
        AudioClip _ambience = null;
        [SerializeField]
        List<AudioClip> _soloDetailSounds = null;
        [SerializeField]
        List<AudioClip> _massDetailSounds = null;

        [SerializeField]
        private float _soloDetailRate = 0.3f;
        [SerializeField]
        private float _massDetailRate = 0.2f;
        [SerializeField]
        private float _hype;
        [SerializeField]
        private float _hypeDecay = 0.01f;
        [SerializeField]
        private float _minHype = 0.2f;
        [SerializeField]
        private float _maxHype = 1.0f;
        #endregion
